...
class TestCompleteCompliance:
    ...
    def test_all_requirements_met(self, bill_factory):
    ...
    def test_house_committee_no_notice_requirement(self, bill_factory):
    ...
    def test_compliant_with_extension(self, bill_factory):
...
class TestNonCompliance:
    ...
    def test_insufficient_notice_is_deal_breaker(self, bill_factory):
        """Insufficient notice should override other compliance."""
        announcement = date(2025, 7, 10)
        hearing = date(2025, 7, 15)  # Only 5 days for Joint committee
        reported = hearing + timedelta(days=20)
    ...
    def test_missing_votes_only(self, bill_factory):
...
class TestEdgeCases:
    ...
    def test_before_deadline(self, bill_factory):
    ...
    def test_missing_notice_no_evidence(self, bill_factory):
    ...
    def test_missing_notice_with_evidence(self, bill_factory):
