...
class TestNoticeRequirements:
    ...
    def test_joint_committee_adequate_notice(self, bill_factory, date_scenarios):
    ...
    def test_joint_committee_inadequate_notice(self, bill_factory, date_scenarios):
    ...
    def test_senate_committee_adequate_notice(self, bill_factory, date_scenarios):
    ...
    def test_house_committee_no_notice_requirement(self, bill_factory, date_scenarios):
    ...
    def test_exempt_before_requirement_date(self, bill_factory, date_scenarios):
    ...
    def test_exact_10_day_notice(self, bill_factory):
    ...
    def test_nine_day_notice_fails(self, bill_factory):
...
class TestNoticeEdgeCases:
    ...
    def test_missing_announcement_no_evidence(self, bill_factory):
