...
class TestNoticeRequirementRule:
    ...
    def test_adequate_notice_joint_committee(self, bill_factory: BillFactory):
    ...
    def test_inadequate_notice_joint_committee(self, bill_factory: BillFactory):
    ...
    def test_exempt_before_requirement_date(self, bill_factory: BillFactory):
...
class TestReportedOutRequirementRule:
    ...
    def test_reported_within_deadline(self, bill_factory: BillFactory):
    ...
    def test_before_deadline_unknown_state(self, bill_factory: BillFactory):
    ...
    def test_votes_compensate_for_missing_reported_date(
    ...
    def test_reported_after_deadline(self, bill_factory: BillFactory):
...
class TestVoteAndSummaryRules:
    ...
    def test_votes_present(self, bill_factory: BillFactory):
    ...
    def test_votes_missing(self, bill_factory: BillFactory):
    ...
    def test_summary_present(self, bill_factory: BillFactory):
